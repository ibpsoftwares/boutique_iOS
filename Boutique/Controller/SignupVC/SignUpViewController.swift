...
//        self.userImg.clipsToBounds = true
    ...
    func signupAPI(){
        ...
        Webservice.apiPost(serviceName: "http://kftsoftwares.com/ecom/recipes/Signup/ZWNvbW1lcmNl/", parameters: parameters, headers: nil) { (response:NSDictionary?, error:NSError?) in
            if error != nil {
